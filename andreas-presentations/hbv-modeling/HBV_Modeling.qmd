...
- Have been considered as treatment options
...
$$
\begin{aligned}
\textrm{Uninfected Bacteria} \qquad \dot{U} & =   - bUV \\
\textrm{Infected Bacteria} \qquad \dot{I} & =  bUV - d_I I \\     
\textrm{Phage} \qquad  \dot{V} & =  pI - d_V V -  bg UV 
\end{aligned}
$$
